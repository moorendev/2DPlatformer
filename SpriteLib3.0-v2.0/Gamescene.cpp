...
void Gamescene::InitScene(float windowWidth, float windowHeight)
{
	...
	//Move sign
	{
		...
		//Sets up componets
		std::string fileName = "Movesign.png";
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(-50.f), float32(80.f));
	...
	//Jump sign
	{
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(-10.f), float32(80.f));
	...
	//Toggle sign
	{
		...
		//Sets up componets
		std::string fileName = "Togglesign.png";
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 40, 40);;
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(30.f, -20.f, 2.f));
		...
		b2BodyDef tempDef;
		tempDef.type = b2_staticBody;
		tempDef.position.Set(float32(660.f), float32(80.f));
...
void Gamescene::KeyboardDown()
{
	...
	if (Input::GetKeyDown(Key::Space) || Input::GetKeyDown(Key::W))
	{
